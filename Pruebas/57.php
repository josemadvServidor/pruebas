...
$pAsigna->Asigna(01, 02, 02);

echo $pAsigna->daHoraTotal();

$pA_segundos = $pAsigna->A_segundos();

echo "<br>" . $pA_segundos;

$pde_Segundos = $pAsigna->de_Segundos(3722);

echo "<br>" . $pAsigna->daHoraTotal();

$segundaHora = new Hora();

$segundaHora->Asigna(00, 01, 02);

$segDesde = $pAsigna->segundos_desde($segundaHora);

echo "<br>" . $segDesde;

echo "<br>";

$pAsigna->Siguiente(7320);

echo "<br>" . $pAsigna->daHoraTotal();

$pAsigna->Anterior(7323);

echo "<br>" . $pAsigna->daHoraTotal();

$pAsigna->CargaHoraSistema();
